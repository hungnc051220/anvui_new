...
export default function Page({ params: { lng } }: { params: { lng: string } }) {
  return (
    <section className="bg-white rounded-2xl shadow-md p-4 md:p-6">
      <SearchInput lng={lng} />
      <div className="grid grid-cols-3 h-8 md:h-12">
        ...
        <div className="flex-center font-bold md:text-lg crumb-mobile md:crumb text-sm -ml-6 z-[2] bg-gray-200">
          <p className="hidden md:block">Thanh toán hoặc giữ chỗ trước</p>
          <p className="block md:hidden">Thanh toán</p>
        </div>
        <div className="flex-center bg-gray-200 font-bold md:text-lg -ml-6 text-sm">
          <p>Hoàn thành</p>
        </div>
      </div>

      <div className="h-8 md:h-10 bg-gray-100 flex items-center gap-4 pl-2 md:pl-10 text-sm md:text-base">
